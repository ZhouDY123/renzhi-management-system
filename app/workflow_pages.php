...
function render_talent_workflow(string $page, PDO $pdo): bool {
    if ($page === 'talent_pool') {
        ...
        $sql = "SELECT c.*, a.post_id AS applied_post_id, p.name AS applied_post_name, r.total_score, r.review_status,
