...
function initQrModals() {
  document.querySelectorAll('a[href*="page=qrcode"]').forEach(link => link.addEventListener('click', async e => {
    ...
    try {
      ...
      const box=overlay.querySelector('.qr-popup-code'); new QRCode(box,{text:value,width:320,height:320,colorDark:'#000',colorLight:'#fff',correctLevel:QRCode.CorrectLevel.M});
