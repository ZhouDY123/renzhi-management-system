...
console.log('PASS: public entry, objective-only scoring, own results, >60 gate, backend 60 rejection, interview, final review, talent admission, retired role, repeated assessment, foreign keys');
